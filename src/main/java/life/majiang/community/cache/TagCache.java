...
public class TagCache {
	public static List<TagDTO> get() {
		...
		language.setTags(Arrays.asList("javascript", "php", "css", "html", "html5", "java", "node.js", "python", "c++",
		...
		framework.setTags(Arrays.asList("laravel", "spring", "mybatis", "express", "django", "flask", "yii",
